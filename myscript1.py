...
class MainScreen0(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        super(MainScreen0, self).__init__(**kwargs)
...
class MainScreen1(Screen):
    ...
    def updateOptions(self, option, pulsl):
        global options
        options = option
        global card
        global puls
        puls = int(pulsl)
        card = False
        print("Option recieved : " + option+ "  puls: "+ pulsl )
        self.ids.OptionID.text = str(option)
        Clock.schedule_once(self.callbackScreen, 1.5)
        return(self)

    def callbackScreen(self, dt):
        self.parent.current = 'main2'
        return(self)
